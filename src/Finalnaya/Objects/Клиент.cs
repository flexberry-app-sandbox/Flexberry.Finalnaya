...
namespace IIS.Finalnaya
{
    ...
    public class Клиент : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Finalnaya.DetailArrayOfДокументы fДокументы;
        ...
        public virtual IIS.Finalnaya.DetailArrayOfДокументы Документы
        {
            get
            {
                ...
                {
                    this.fДокументы = new IIS.Finalnaya.DetailArrayOfДокументы(this);
                }
                IIS.Finalnaya.DetailArrayOfДокументы result = this.fДокументы;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View КлиентE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КлиентE", typeof(IIS.Finalnaya.Клиент));
                }
            }
            ...
            public static ICSSoft.STORMNET.View КлиентL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КлиентL", typeof(IIS.Finalnaya.Клиент));
                }
            }
        }
    }
