...
namespace IIS.Finalnaya
{
    ...
    public class Оплата : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Finalnaya.ТипОплаты fТипОплаты;
        ...
        public virtual IIS.Finalnaya.ТипОплаты ТипОплаты
        {
            get
            {
                ...
                IIS.Finalnaya.ТипОплаты result = this.fТипОплаты;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ОплатаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ОплатаE", typeof(IIS.Finalnaya.Оплата));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ОплатаL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ОплатаL", typeof(IIS.Finalnaya.Оплата));
                }
            }
        }
    }
