...
namespace IIS.Finalnaya
{
    ...
    public class Документы : ICSSoft.STORMNET.DataObject
    {
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Finalnaya.Клиент.
        /// </summary>
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ДокументыE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДокументыE", typeof(IIS.Finalnaya.Документы));
                }
            }
        }
    }
    ...
    public class DetailArrayOfДокументы : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Finalnaya.DetailArrayOfДокументы members)

        // *** End programmer edit section *** (IIS.Finalnaya.DetailArrayOfДокументы members)
        ...
        /// </summary>
        public DetailArrayOfДокументы(IIS.Finalnaya.Клиент fКлиент) : 
                base(typeof(Документы), ((ICSSoft.STORMNET.DataObject)(fКлиент)))
        {
        }
        
        public IIS.Finalnaya.Документы this[int index]
        {
            get
            {
                return ((IIS.Finalnaya.Документы)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Finalnaya.Документы dataobject)
        {
