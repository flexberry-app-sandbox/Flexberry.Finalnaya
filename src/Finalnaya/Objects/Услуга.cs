...
namespace IIS.Finalnaya
{
    ...
    public class Услуга : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Finalnaya.DetailArrayOfСоставУслуги fСоставУслуги;
        ...
        public virtual IIS.Finalnaya.DetailArrayOfСоставУслуги СоставУслуги
        {
            get
            {
                ...
                {
                    this.fСоставУслуги = new IIS.Finalnaya.DetailArrayOfСоставУслуги(this);
                }
                IIS.Finalnaya.DetailArrayOfСоставУслуги result = this.fСоставУслуги;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View УслугаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("УслугаE", typeof(IIS.Finalnaya.Услуга));
                }
            }
            ...
            public static ICSSoft.STORMNET.View УслугаL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("УслугаL", typeof(IIS.Finalnaya.Услуга));
                }
            }
        }
    }
