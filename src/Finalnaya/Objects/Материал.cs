...
namespace IIS.Finalnaya
{
    ...
    public class Материал : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Finalnaya.Производитель fПроизводитель;
        ...
        [PropertyStorage(new string[] {
                "Производитель"})]
        [NotNull()]
        public virtual IIS.Finalnaya.Производитель Производитель
        {
            get
            {
                ...
                IIS.Finalnaya.Производитель result = this.fПроизводитель;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View МатериалE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("МатериалE", typeof(IIS.Finalnaya.Материал));
                }
            }
            ...
            public static ICSSoft.STORMNET.View МатериалL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("МатериалL", typeof(IIS.Finalnaya.Материал));
                }
            }
        }
    }
